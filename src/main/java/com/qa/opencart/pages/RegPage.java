...
public class RegPage {
	...
	private By registerSucessMesg=By.cssSelector("#content h1");
	...
	public boolean registerUser(String firstName,String lastName,String email,String telephone,String password,String subscribe) {
		...
		String sucessMesg=eleUtil.waitForElementVisible(registerSucessMesg, TimeUtil.DEFAULT_TIME_OUT).getText();
		System.out.println(sucessMesg);
		
		
		if(sucessMesg.contains(AppConstants.ACCOUNT_REGISTER_SUCESS_MESSG)) {
